Blockly.Python["sand_table_robot__create"] = function(block) {
  ...
  var code = "sandMachine = sand_table_robot.SandTableRobot(" + motor1_pins + ", " + motor2_pins + ", " + sensor_shoulder_pin + ", " + sensor_elbow_pin + ", " + L1 + ", " + L2 + ", " + steps_per_rev + ", " + backlash_deg_m1 + ", " + backlash_deg_m2 + ", " + homing_dir_shoulder + ", " + homing_dir_elbow + ", " + homing_clear_steps + ", " + default_speed_ms + ")" + "\n";
  return code;
};
...
Blockly.Python["sand_table_robot__move_line"] = function(block) {
  ...
  var code = "sandMachine.move_line(" + target_x + ", " + target_y + ", " + segments + ", " + speed + ")" + "\n";
  return code;
};
...
Blockly.Python["sand_table_robot__move_arc"] = function(block) {
  ...
  var segments = Blockly.Python.valueToCode(block, "segments", Blockly.Python.ORDER_ATOMIC);
  var speed = Blockly.Python.valueToCode(block, "speed", Blockly.Python.ORDER_ATOMIC);
  var code = "sandMachine.move_arc(" + center_x + ", " + center_y + ", " + radius + ", " + start_angle + ", " + end_angle + ", " + segments + ", " + speed + ")" + "\n";
  return code;
};
...
Blockly.Python["sand_table_robot__draw_spiral"] = function(block) {
  ...
  var speed = Blockly.Python.valueToCode(block, "speed", Blockly.Python.ORDER_ATOMIC);
  var code = "sandMachine.draw_spiral(" + max_radius + ", " + vindinger + ", " + segments_pr_omgang + ", " + speed + ")" + "\n";
  return code;
};
...
Blockly.Python["sand_table_robot__draw_flower"] = function(block) {
  ...
  var speed = Blockly.Python.valueToCode(block, "speed", Blockly.Python.ORDER_ATOMIC);
  var code = "sandMachine.draw_flower(" + max_radius + ", " + petals + ", " + speed + ")" + "\n";
  return code;
};
...
Blockly.Python["sand_table_robot__run_gcode_text"] = function(block) {
  ...
  var code = "sandMachine.run_gcode_text(" + gcode_text + ", " + segments + ", " + draw_speed_ms + ", " + travel_speed_ms + ", " + reset_modal + ")" + "\n";
  return code;
};
...
Blockly.Python["sand_table_robot__run_gcode_file"] = function(block) {
  ...
  var travel_speed_ms = Blockly.Python.valueToCode(block, "travel_speed_ms", Blockly.Python.ORDER_ATOMIC);
  var reset_modal = Blockly.Python.valueToCode(block, "reset_modal", Blockly.Python.ORDER_ATOMIC);
  var code = "sandMachine.run_gcode_file(" + path + ", " + segments + ", " + draw_speed_ms + ", " + travel_speed_ms + ", " + reset_modal + ")" + "\n";
  return code;
};
