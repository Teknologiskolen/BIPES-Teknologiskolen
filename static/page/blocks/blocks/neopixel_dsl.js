Blockly.Blocks["neopixel__create"] = {
  init: function() {
    ...
    this.appendValueInput("mode").setCheck("String").appendField((Blockly.Msg["BLBL_MODE"]||"Mode"));
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(45);
    this.setInputsInline(true);
    this.setTooltip((Blockly.Msg["BTIP_NEOPIXEL_CREATE"]||"Create the NeoPixel strip (number of LEDs, PIO state machine 0-7, data pin, colour order)."));
